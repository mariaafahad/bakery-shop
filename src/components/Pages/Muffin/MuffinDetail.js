...
const MuffinDetail = ({ muffinDetail }) => {
    const { _id, name, Ingredients, img, size, price } = muffinDetail;
    return (
        ...
        <div class="max-w-lg mx-auto">
            <div class="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm mb-5 hover:shadow-xl hover:scale-105 duration-500 transform transition cursor-pointer">
                ...
                <div class="p-5">
                    ...
                    <p class="font-normal text-gray-700 mb-3">Description:{Ingredients}</p>
                    <h5>Price:{price}</h5>
                    <h5>Size:{size}</h5>
